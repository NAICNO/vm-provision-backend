...
$$
    DECLARE
        nrec_id uuid;
    BEGIN
        INSERT INTO provider (provider_name, description, display_order) VALUES ('NREC', 'Norwegian Research and Education Cloud', 7) RETURNING provider_id INTO nrec_id;
...
$$
    DECLARE
        nrec_uio_id uuid;
    BEGIN
        INSERT INTO provider (provider_name, description, display_order) VALUES ('NREC UiO', 'Norwegian Research and Education Cloud', 2) RETURNING provider_id INTO nrec_uio_id;
...
$$
    DECLARE
        nrec_uib_id uuid;
    BEGIN
        INSERT INTO provider (provider_name, description, display_order) VALUES ('NREC UiB', 'Norwegian Research and Education Cloud', 3) RETURNING provider_id INTO nrec_uib_id;
...
$$
    DECLARE
        gcloud_id uuid;
    BEGIN
        INSERT INTO provider (provider_name, description, display_order) VALUES ('Google Cloud', 'Google Cloud', 5) RETURNING provider_id INTO gcloud_id;
...
$$
    DECLARE
        azure_id uuid;
    BEGIN
        INSERT INTO provider (provider_name, description, display_order) VALUES ('Azure', 'Microsoft Azure', 6) RETURNING provider_id INTO azure_id;
...
$$
    DECLARE
        ibm_id uuid;
    BEGIN
        INSERT INTO provider (provider_name, description, display_order) VALUES ('IBM Cloud', 'IBM Cloud', 4) RETURNING provider_id INTO ibm_id;

        INSERT INTO public.vm_template (template_name, provider_id, cpu, ram, storage, os, description, flavor_name, metadata, enabled) VALUES ('Power 11 Medium', ibm_id, 4, 16, 120, 'CentOS-Stream-10', 'Power 11  VM for medium workloads', 'power11.medium', '{ "username": "root", "tags": ["simple"]}', true);

        INSERT INTO public.vm_template (template_name, provider_id, cpu, ram, storage, os, description, flavor_name, metadata, enabled) VALUES ('Power 11 Small', ibm_id, 2, 4, 120, 'CentOS-Stream-10', 'Power 11 VM for medium workloads', 'power11.small', '{ "username": "root", "tags": ["advanced"]}', true);
        INSERT INTO public.vm_template (template_name, provider_id, cpu, ram, storage, os, description, flavor_name, metadata, enabled) VALUES ('Power 11 Medium', ibm_id, 4, 16, 120, 'CentOS-Stream-10', 'Power 11  VM for medium workloads', 'power11.medium', '{ "username": "root", "tags": ["advanced"]}', true);
        INSERT INTO public.vm_template (template_name, provider_id, cpu, ram, storage, os, description, flavor_name, metadata, enabled) VALUES ('Power 11 Large', ibm_id, 8, 32, 120, 'CentOS-Stream-10', 'Power 11  VM for large workloads', 'power11.large', '{ "username": "root", "tags": ["advanced"]}', true);
...
$$
    DECLARE
        nscale_id uuid;
    BEGIN
        INSERT INTO provider (provider_name, description, display_order) VALUES ('Nscale', 'NScale', 1) RETURNING provider_id INTO nscale_id;
