...
IMAGE_NAME="provision-request-queue-consumer"
KUBE_CONTEXT="naic-och-dev"
DEPLOYMENT_NAME="provision-request-queue-consumer"
...
echo "🔨 Building DEV version: ${VERSION_TAG}"
...
if [ $? -eq 0 ]; then
  echo "✅ DEV Deployment successful! Version: ${VERSION_TAG}"
  echo ""
